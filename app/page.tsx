...
export default function Home() {
  ...
  const [removeAmounts, setRemoveAmounts] =
    useState<Record<number, string>>({});
  ...
  async function removeStock(
    ...
    if (amount > currentStock) {
      alert(
        `Cannot remove ${amount}. Available stock: ${currentStock}.`
      );
      return;
    }
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-100 via-white to-slate-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-7">
        ...
        {/* OVERVIEW */}
        <section className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 mb-5 sm:mb-7">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5">
                  <div>
                    ...
                    <p className="text-slate-400 text-sm mt-2 max-w-2xl">
                      ...
                      shops, including prices, stock, sales
                      and reports.
                    </p>
                  </div>
